...
public class CommandRegistry {
    ...
    private static class CommandHandlerImpl implements CommandHandler {
        ...
        /**
         * Find command responsible for handling given line.
         *
         * @param smtpline
         * @return
         */
        ...
        /**
         * Try to get SMTP command from given string.
         *
