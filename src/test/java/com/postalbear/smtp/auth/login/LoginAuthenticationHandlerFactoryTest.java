...
public class LoginAuthenticationHandlerFactoryTest {
    ...
    @InjectMocks
    private LoginAuthenticationHandlerFactory factory;

    @Test
    public void testGetAuthenticationMechanisms() throws Exception {
        assertEquals(Collections.singleton("LOGIN"), factory.getAuthenticationMechanisms());
    }
